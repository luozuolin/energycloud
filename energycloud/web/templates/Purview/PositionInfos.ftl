...
<script>
    ...
    $(document).ready(function () {
        ...
        table=new $.quake.comp.datatables({
            id:"tableedit",
            columns:[
                { data: "numPositionID",text:"numPositionID" ,"orderable": true,visible:false},

                { data: "varPositionName",text:"岗位名称" ,edit:{
                    type:"text"
                }},

            ],
            dataurl:"/WD_Position/read",
            //添加删除修改所在的页面
            updateurl:"/WD_Position/edit/",
            selectstyle:"multi",
            "data":function(){
