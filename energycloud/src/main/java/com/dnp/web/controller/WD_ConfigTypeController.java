...
import com.dnp.web.service.WD_ConfigTypeService;
 ...
 */
@Controller
@RequestMapping("/WD_ConfigType")
public class WD_ConfigTypeController {
    @Autowired
    WD_ConfigTypeService wd_configTypeService;
    ...
    public String read(HttpServletRequest request) {
        List<HashMap> datas=wd_configTypeService.listAll();
